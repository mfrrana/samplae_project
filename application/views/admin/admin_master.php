...
<html lang="en">
    <head>
        ...
        -->
        <meta charset="utf-8">
        <title>ApplianceBD | Admin Panel</title>
    ...
    <body>
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="index.html"> <img alt="Charisma Logo" src="<?php echo base_url(); ?>img/logo20.png" /> <span>ApplianceBD</span></a>
        ...
        <div class="container-fluid">
                ...
                <div class="span2 main-menu-span">
                    <div class="well nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/dashboard"><i class="icon-home"></i><span class="hidden-tablet"> Dashboard</span></a></li>
                            ...
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_manufacturer"><i class="icon-list-alt"></i><span class="hidden-tablet"> Add Manufacturer</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/manage_manufacturer"><i class="icon-font"></i><span class="hidden-tablet"> Manage Manufactur</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_product"><i class="icon-picture"></i><span class="hidden-tablet">Add Product</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/manage_product"><i class="icon-picture"></i><span class="hidden-tablet">Manage Product</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/slider_panel"><i class="icon-picture"></i><span class="hidden-tablet">Slider</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/manage_slide"><i class="icon-picture"></i><span class="hidden-tablet">Manage Slide</span></a></li>
            ...
            <footer>
                ...
                <p class="pull-right">Designed by: <a href="http://usman.it/free-responsive-admin-template">Charisma</a></p>
            </footer>
