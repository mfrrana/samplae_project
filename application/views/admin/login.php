				...
				<div class="well span5 center login-box">
					<div class="alert alert-info">
                                            <h2 style="color: red">
                                                ...
                                                $fail_msg = $this->session->userdata('login_fail');
                                                if($fail_msg){
                                            ...
                                            <h2 style="color: green">
                                                ...
                                                $lgout_msg = $this->session->userdata('logout_msg');
                                                if($lgout_msg){
						...
						<fieldset>
							<div class="input-prepend" title="Email" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="admin_email_address" id="username" type="text" value="admin email address" />
							</div>
